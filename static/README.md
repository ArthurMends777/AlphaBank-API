...
Este é o frontend do Alpha Bank, totalmente integrado com a API desenvolvida em Rust e MySQL.
...
// Altere para o endereço de produção, se necessário.
```

### CORS

O backend já está configurado para desenvolvimento. Para um ambiente de produção, o CORS deve ser configurado no backend (`main.rs`) para aceitar requisições apenas do domínio de origem do frontend:
